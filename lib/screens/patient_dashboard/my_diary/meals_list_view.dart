    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasData) {
            ...
            try {
              calorie2 = double.parse(snapshot.data!.docs[2]["Total Calories"]);
            } catch (e) {
              calorie2 = 0;
            }
            try {
              calorie3 = double.parse(snapshot.data!.docs[3]["Total Calories"]);
            } catch (e) {
              calorie3 = 0;
            }
            try {
              calorie4 = double.parse(snapshot.data!.docs[1]["Total Calories"]);
            } catch (e) {
              calorie4 = 0;
            }
          }
