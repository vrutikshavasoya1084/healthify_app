          ...
          return StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context,
                ...
                if (snapshot.hasData) {
                  ...
                  carbsPercent = double.parse(((consumedCarb / targetCarb) * 70)
                              .toStringAsFixed(0))
                          .isNaN
                      ? 0
                      : double.parse(((consumedCarb / targetCarb) * 70)
                          .toStringAsFixed(0));
                  proteinPercent = double.parse(
                              ((consumedProtein / targetProtein) * 70)
                                  .toStringAsFixed(0))
                          .isNaN
                      ? 0
                      : double.parse(((consumedProtein / targetProtein) * 70)
                          .toStringAsFixed(0));
                  fatPercent = double.parse(((consumedFat / targetFat) * 70)
                              .toStringAsFixed(0))
                          .isNaN
                      ? 0
                      : double.parse(
                          ((consumedFat / targetFat) * 70).toStringAsFixed(0));
                }
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      Text(
                                                        '${(targetCalories - consumedCalories).toStringAsFixed(2)}',
                                                        textAlign:
                                                            TextAlign.center,
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                '${(targetCarb - consumedCarb).toStringAsFixed(0)}g left',
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                  fontFamily:
                                                      FitnessAppTheme.fontName,
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          top: 6),
                                                  child: Text(
                                                    '${(targetProtein - consumedProtein).toStringAsFixed(0)}g left',
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                                                      fontFamily:
                                                          FitnessAppTheme
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          top: 6),
                                                  child: Text(
                                                    '${(targetFat - consumedFat).toStringAsFixed(0)}g left',
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                                                      fontFamily:
                                                          FitnessAppTheme
