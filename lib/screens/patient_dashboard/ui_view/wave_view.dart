        ...
        builder: (context, child) => Stack(
          children: <Widget>[
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: FitnessAppTheme.lightPurple1.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.lightPurple.withOpacity(0.2),
                      FitnessAppTheme.lightPurple1.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: FitnessAppTheme.lightPurple1,
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.lightPurple1.withOpacity(0.4),
